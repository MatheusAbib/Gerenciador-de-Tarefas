...
import { task, TASK_INTERNAL_SERVER_ERROR_RESPONSE, TASK_UNPROCESSIBLE_ENTITY_RESPONSE, tasks } from "../../../_mock_/tasks";
...
describe('createTask', () => {
  ...
  it('should create create a new task', () => {
    let task: Task | undefined;
...
describe('updateIsCompletedStatus', () => {
  ...
  it("should throw and error when update a task isCompleted status", waitForAsync(() => {
    ...
    taskService.updateIsCompletedStatus(updatedTask.id, true)
    .subscribe({
      next: () => {
